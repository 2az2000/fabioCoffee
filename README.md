...
### ۲.۴. دسترسی به پنل مدیریت

*   **آدرس پنل مدیریت**: `http://localhost:3000/admin/login`
*   **اعتبارنامه‌های دمو (پیش‌فرض)**:
    *   ایمیل: `admin@fabiocafe.com`
    *   رمز عبور: `admin123` (اگر اسکریپت `seed.ts` این کاربر را ایجاد کرده باشد)