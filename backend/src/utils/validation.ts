...
const baseItemSchema = z.object(itemSchemaFields);

export const createItemSchema = baseItemSchema.superRefine((data, ctx) => {
  if (data.isWeighted) {
    ...
    .array(
      z.object({
        ...
        quantity: z
          ...
          .max(100, "Quantity must be 100 or less"), // تعداد
      })
    )
