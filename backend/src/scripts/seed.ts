...
const seedDatabase = async () => {
  try {
    ...
    const tables = await Promise.all([
      prisma.table.create({ data: { number: 1, capacity: 2 } }),
      prisma.table.create({ data: { number: 2, capacity: 2 } }),
      prisma.table.create({ data: { number: 3, capacity: 4 } }),
      prisma.table.create({ data: { number: 4, capacity: 4 } }),
      prisma.table.create({ data: { number: 5, capacity: 6 } }),
      prisma.table.create({ data: { number: 6, capacity: 8 } })
    ]);
